...
$pets=getAdoptedPets($speciesFilter);
    ...
    echo '<tr>
                    ...
                    <td  id="btn">
                        <form method="POST" action="/profile.php" >
                            <input type="hidden" name="id" value="' . $pet->adopter_id . '">
                            <input type="submit" value="' . $pet->adopter_id . '" />
                        </form>
                    </td>
                    ...
                    <td  id="btn">
                        <form method="GET" action="/update_pet.php" >
                            ...
                            <input type="hidden" name="adopter_id" value="' . $pet->adopter_id . '">
